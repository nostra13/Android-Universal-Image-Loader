...
public class BaseImageDownloader implements ImageDownloader {
    ...
    protected InputStream getStreamFromFile(String imageUri, Object extra) throws IOException {
        ...
        if (isVideoFileUri(imageUri)) {
            ...
            BufferedInputStream imageStream = new BufferedInputStream(new SafeFileInputStream(filePath), BUFFER_SIZE);
            return new ContentLengthInputStream(imageStream, (int) new SafeFile(filePath).length());
        }
    }
