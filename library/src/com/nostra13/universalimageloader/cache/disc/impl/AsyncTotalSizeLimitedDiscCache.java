...
import com.nostra13.universalimageloader.cache.disc.AsyncLimitedDiscCache;

import java.io.File;import java.lang.Override;
 ...
 */
public class AsyncTotalSizeLimitedDiscCache extends AsyncLimitedDiscCache {
     ...
     */
    public AsyncTotalSizeLimitedDiscCache(File cacheDir, int maxCacheSize) {
     ...
     *            oldest last usage date will be deleted.
     */
    public AsyncTotalSizeLimitedDiscCache(File cacheDir, FileNameGenerator fileNameGenerator, int maxCacheSize) {
