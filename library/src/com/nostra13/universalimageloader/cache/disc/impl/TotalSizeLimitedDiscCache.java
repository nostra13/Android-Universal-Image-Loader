...
public class TotalSizeLimitedDiscCache extends LimitedDiscCache {
	 ...
	 */
	public TotalSizeLimitedDiscCache(File cacheDir, File reserveCacheDir, FileNameGenerator fileNameGenerator,
			int maxCacheSize) {
		super(cacheDir, reserveCacheDir, fileNameGenerator, maxCacheSize);
