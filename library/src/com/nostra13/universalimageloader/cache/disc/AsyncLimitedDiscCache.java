 ...
 */
public abstract class AsyncLimitedDiscCache extends BaseDiscCache {
     ...
     *            deleted.
     */
    public AsyncLimitedDiscCache(File cacheDir, int sizeLimit) {
     ...
     *            deleted.
     */
    public AsyncLimitedDiscCache(File cacheDir, FileNameGenerator fileNameGenerator, int sizeLimit) {
        super(cacheDir, fileNameGenerator);
        this.sizeLimit = sizeLimit;
        calculateCacheSizeAndFillUsageMapAsync();
    }

    private void calculateCacheSizeAndFillUsageMapAsync() {
